...
public class BaseView : BaseUI, IBaseView
{
    ...
    public virtual void Init(params object[] _params)
    {
        ...
        //canvasScaler.referenceResolution = new Vector2(2048, 1080);
        //bg
    ...
    public virtual void OnClose(Action _cb)
    {
        ...
        if (viewConfig.showMethod == ViewShowMethod.pop)
        {
            ...
            __content.DOScale(0, 0.5f).SetEase(Ease.OutBack).onComplete = () =>
            {
                _cb?.Invoke();
            };
        }
    ...
    {
        return Timer.Ins.GetGroupName(TimerGroup.view, this);
    }
