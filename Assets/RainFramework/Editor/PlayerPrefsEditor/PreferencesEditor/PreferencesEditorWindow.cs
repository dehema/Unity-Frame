...
#region ErrorValues
        ...
        private void OnEnable()
        {
            ...
            monitoring = F8EditorPrefs.GetBool("Rain.Core.Editor.WatchingForChanges", true);
            if(monitoring)
                entryAccessor.StartMonitoring();

            sortOrder = (PreferencesEntrySortOrder) F8EditorPrefs.GetInt("Rain.Core.Editor.SortOrder", 0);
        ...
        private void InitReorderedList()
        {
            ...
            relSpliterPos = F8EditorPrefs.GetFloat("Rain.Core.Editor.RelativeSpliterPosition", 100 / position.width);
        ...
        private void OnDrawElementBackgroundCallback(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            if (Event.current.type == EventType.MouseUp)
            {
                ...
                F8EditorPrefs.SetFloat("Rain.Core.Editor.RelativeSpliterPosition", relSpliterPos);
            }
        }
        ...
        void OnGUI()
        {
            ...
            try
            {
                ...
                if (GUILayout.Button(sortOrderContent, EditorStyles.toolbarButton))
                {
                    ...
                    F8EditorPrefs.SetInt("Rain.Core.Editor.SortOrder", (int) sortOrder);
                    PrepareData(false);
                }
                ...
                if (GUILayout.Button(watcherContent, EditorStyles.toolbarButton))
                {
                    ...
                    F8EditorPrefs.SetBool("Rain.Core.Editor.WatchingForChanges", monitoring);
