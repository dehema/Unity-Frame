...
namespace Rain.Core
{
    public static class TweenExtension
    {
        ...
        {
            return F8Tween.Instance.ScaleXAtSpeed(obj, value, speed);
        }
        ...
        {
            return F8Tween.Instance.ScaleY(obj, value, t);
        }
        ...
        {
            return F8Tween.Instance.ScaleYAtSpeed(obj, value, speed);
        }
        ...
        {
            return F8Tween.Instance.RotateTween(t, axis, to, time);
        }

        public static BaseTween RotateTween(this Transform t, Vector3 to, float time)
        {
            return F8Tween.Instance.RotateTween(t, to, time);
        }
        ...
        {
            return F8Tween.Instance.RotateTween(go.transform, to, time);
        }

        public static BaseTween RotateTween(this GameObject go, Vector3 axis, float to, float time)
        {
            return F8Tween.Instance.RotateTween(go, axis, to, time);
        }
        ...
        {
            return F8Tween.Instance.RotateTween(rect, to, time);
        }
        ...
        {
            return F8Tween.Instance.Move(rect, pos, t);
        }

        public static BaseTween MoveAtSpeed(this RectTransform rect, Vector2 pos, float speed)
        {
            return F8Tween.Instance.MoveAtSpeed(rect, pos, speed);
        }
        ...
        {
            return F8Tween.Instance.MoveUI(rect, absolutePosition, canvas, t, pivotPreset);
        }
        ...
        {
            return F8Tween.Instance.ShakePositionAtSpeed(obj, vibrato, shakeCount, speed);
        }
        ...
        public static Sequence ShakeRotation(this Transform obj, Vector3 vibrato, int shakeCount = 8, float t = 0.05f,
            bool fadeOut = false)
        {
            return F8Tween.Instance.ShakeRotation(obj, vibrato, shakeCount, t);
        }

        public static Sequence ShakeRotation(this GameObject obj, Vector3 vibrato, int shakeCount = 8, float t = 0.05f,
            bool fadeOut = false)
        {
            return F8Tween.Instance.ShakeRotation(obj.transform, vibrato, shakeCount, t);
        }

        public static Sequence ShakeRotationAtSpeed(this Transform obj, Vector3 vibrato, int shakeCount = 8,
            float speed = 5f, bool fadeOut = false)
        {
            return F8Tween.Instance.ShakeRotationAtSpeed(obj, vibrato, shakeCount, speed);
        }
        ...
        public static Sequence ShakeScale(this Transform obj, Vector3 vibrato, int shakeCount = 8, float t = 0.05f,
            bool fadeOut = false)
        {
            return F8Tween.Instance.ShakeScale(obj, vibrato, shakeCount, t);
        }

        public static Sequence ShakeScale(this GameObject obj, Vector3 vibrato, int shakeCount = 8, float t = 0.05f,
            bool fadeOut = false)
        {
            return F8Tween.Instance.ShakeScale(obj.transform, vibrato, shakeCount, t);
        }
        ...
        public static Sequence ShakeScaleAtSpeed(this Transform obj, Vector3 vibrato, int shakeCount = 8,
            ...
            bool fadeOut = false)
        {
            return F8Tween.Instance.ShakeScaleAtSpeed(obj, vibrato, shakeCount, speed);
        }
        ...
        {
            F8Tween.Instance.CancelTween(go);
        }

        public static void CancelTween(this GameObject go, int id)
        {
            F8Tween.Instance.CancelTween(id);
        }
    }
}