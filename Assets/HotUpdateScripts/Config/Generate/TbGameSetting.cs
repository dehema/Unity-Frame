...
/// 设置
/// </summary>
public partial class TbGameSetting
{
    ...
    public TbGameSetting(JSONNode _buf)
    {
        ...
        foreach(JSONNode _ele in _buf.Children)
        {
            ...
            { if(!_ele.IsObject) { throw new SerializationException(); }  _v = global::Rain.Core.GameSettingConfig.DeserializeGameSettingConfig(_ele);  }
            _dataList.Add(_v);
